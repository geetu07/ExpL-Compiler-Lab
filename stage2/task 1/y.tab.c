...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MUL = 5,                        /* MUL  */
  YYSYMBOL_DIV = 6,                        /* DIV  */
  YYSYMBOL_ENDK = 7,                       /* ENDK  */
  YYSYMBOL_BEGINK = 8,                     /* BEGINK  */
...
static const char *const yytname[] =
{
  ...
  "DIV", "ENDK", "BEGINK", "READ", "WRITE", "ASSIGN", "SEMICOLON", "ID",
  "NUM", "'('", "')'", "$accept", "program", "stmtlist", "stmt",
...
{
      -7,    14,    32,    10,    18,    23,    28,    21,   -17,   -17,
     -17,   -17,   -17,   -17,    27,    22,    22,    29,   -17,    26,
     -17,   -17,    22,     4,    -1,   -17,    31,    13,    22,    22,
      22,    22,    33,   -17,   -17,   -17,    20,    20,   -17,   -17,
     -17
};
...
static const yytype_int8 yytable[] =
{
      ...
      31,    33,    36,    37,    38,    39,    28,    29,    30,    31,
      32,     3,    13,     4,     5,    30,    31,     6,    17,    35,
       4,     5,    12,    14,     6,    20,    21,    22,    15,    16,
      19,    25,    26,    34,    18,    40
};

static const yytype_int8 yycheck[] =
{
      16,     8,     3,     4,     5,     6,    22,     3,     4,     5,
       6,    12,    28,    29,    30,    31,     3,     4,     5,     6,
      16,     7,    12,     9,    10,     5,     6,    13,     7,    16,
       9,    10,     0,    15,    13,    13,    14,    15,    15,    11,
      13,    12,    16,    12,     7,    12
};
...
{
       0,     8,    18,     7,     9,    10,    13,    19,    20,    21,
      22,    23,     0,    12,    15,    15,    11,     7,    20,    13,
      13,    14,    15,    24,    24,    12,    16,    24,     3,     4,
       5,     6,    16,    12,    12,    16,    24,    24,    24,    24,
      12
};
...
#line 30 "ex1.y"
                                                {printf("Done!");(yyval.no)=NULL;}
#line 1194 "y.tab.c"
    break;

  case 4: /* stmtlist: stmtlist stmt  */
#line 33 "ex1.y"
                        { (yyval.no)=createConnect((yyvsp[-1].no),(yyvsp[0].no));}
#line 1200 "y.tab.c"
    break;
...
#line 41 "ex1.y"
                                          {(yyval.no)=createRead((yyvsp[-2].no));}
#line 1230 "y.tab.c"
    break;

  case 10: /* OutputStmt: WRITE '(' expr ')' SEMICOLON  */
#line 43 "ex1.y"
                                             {(yyval.no)=createWrite((yyvsp[-2].no));}
#line 1236 "y.tab.c"
    break;

  case 11: /* AsgStmt: ID ASSIGN expr SEMICOLON  */
#line 45 "ex1.y"
                                         {(yyval.no)=createAssign((yyvsp[-3].no),(yyvsp[-1].no));}
#line 1242 "y.tab.c"
    break;
